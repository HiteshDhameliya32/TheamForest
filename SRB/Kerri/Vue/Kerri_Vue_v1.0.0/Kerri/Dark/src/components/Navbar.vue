...
<template>
    <b-nav class="navbar navbar-expand-lg custom-nav fixed-top sticky sticky-dark" :class="{ 'stickyadd': isNavSticky }"
        id="navbar">
        <div class="container">
            ...
            <button @click="toggleMenu" class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
