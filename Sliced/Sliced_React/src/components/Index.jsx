    ...
    <>
      ...
      <div className="flex flex-col gap-4 min-h-[calc(100vh-212px)]">
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-darklight dark:border-darkborder border border-black/10 p-5 gap-6 flex justify-between items-center rounded">
            <div>
              <p className="text-base dark:text-white/80">Total Views</p>
              <h4 className="text-black dark:text-white text-2xl items-center font-semibold flex gap-4 mt-3">
                15102
                <span className="bg-success/20 text-success rounded-md p-1 text-sm leading-none">
                  23%
                </span>
              </h4>
          ...
          <div className="bg-white dark:bg-darklight dark:border-darkborder border border-black/10 p-5 gap-6 flex justify-between items-center rounded">
            <div>
              <p className="text-base dark:text-white/80">Paid Visits</p>
              <h4 className="text-black dark:text-white text-2xl items-center font-semibold flex gap-4 mt-3">
                4581
                <span className="bg-danger/20 text-danger rounded-md p-1 text-sm leading-none">
                  24%
                </span>
              </h4>
              <p className="text-muted">Current Month</p>
          ...
          <div className="bg-white dark:bg-darklight dark:border-darkborder border border-black/10 p-5 gap-6 flex justify-between items-center rounded">
            <div>
              <p className="text-base dark:text-white/80">Total Referral</p>
              <h4 className="text-black dark:text-white text-2xl items-center font-semibold flex gap-4 mt-3">
                2140
                <span className="bg-danger/20 text-danger rounded-md p-1 text-sm leading-none">
                  10%
          ...
          <div className="bg-white dark:bg-darklight dark:border-darkborder border border-black/10 p-5 gap-6 flex justify-between items-center rounded">
            <div>
              <p className="text-base dark:text-white/80">This Week</p>
              <h4 className="text-black dark:text-white text-2xl items-center font-semibold flex gap-4 mt-3">
                7714
                <span className="bg-success/20 text-success rounded-md p-1 text-sm leading-none">
                  82%
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-darklight dark:border-darkborder border md:col-span-2 xl:col-span-2 border-black/10 p-5 gap-6 rounded">
            <div className="flex items-center justify-between gap-4 mb-4">
              <h2 className="text-base font-semibold text-black dark:text-white/80">
                Total Revenue
              </h2>
              <div>
                <div id="dropdownContainer" className="dropdown ml-auto">
                  <a
                    href="#"
                    id="toggleButton"
                  ...
                  <ul
                    id="dropdownMenu"
                    className="right-0 whitespace-nowrap hidden"
                  >
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="space-y-1">
                <div className="flex items-center gap-4">
                  <span className="text-purple h-10 w-10 bg-purple/20 rounded flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      width="24"
                  ...
                  <div>
                    <p className="dark:text-white">Chrome</p>
                    <p className="text-muted">Top Browser</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 justify-between">
                  <div className="relative h-1 w-full bg-black/10 dark:bg-darkborder  rounded-2xl">
                    <div className="bg-purple h-full w-[56%] rounded-2xl"></div>
                  </div>
                  <p className="text-purple text-[15px] leading-[22px] font-medium flex-none">
                    56%
                  </p>
                </div>
              </div>
              <div className="space-y-1">
                <div className="flex items-center gap-4">
                  <span className="text-black dark:text-white  h-10 w-10 bg-black/20 dark:bg-white/10 rounded flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      width="24"
                  ...
                  <div>
                    <p className="dark:text-white">Safari</p>
                    <p className="text-muted">Top Browser</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 justify-between">
                  <div className="relative h-1 w-full bg-black/10 dark:bg-darkborder rounded-2xl">
                    <div className="bg-black dark:bg-white h-full w-[86%] rounded-2xl"></div>
                  </div>
                  <p className="text-black dark:text-white text-[15px] leading-[22px] font-medium flex-none">
                    86%
                  </p>
                </div>
              </div>
              <div className="space-y-1">
                <div className="flex items-center gap-4">
                  <span className="text-danger h-10 w-10 bg-danger/20 rounded flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      width="24"
                  ...
                  <div>
                    <p className="dark:text-white">Forefox</p>
                    <p className="text-muted">Top Browser</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 justify-between">
                  <div className="relative h-1 w-full bg-black/10 dark:bg-darkborder  rounded-2xl">
                    <div className="bg-danger h-full w-[65%] rounded-2xl"></div>
                  </div>
                  <p className="text-danger text-[15px] leading-[22px] font-medium flex-none">
                    65%
                  </p>
                </div>
              </div>
              <div className="space-y-1">
                <div className="flex items-center gap-4">
                  <span className="text-info h-10 w-10 bg-info/20  rounded flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      width="24"
                  ...
                  <div>
                    <p className="dark:text-white">Edge</p>
                    <p className="text-muted">Top Browser</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 justify-between">
                  <div className="relative h-1 w-full bg-black/10 dark:bg-darkborder  rounded-2xl">
                    <div className="bg-info h-full w-[40%] rounded-2xl"></div>
                  </div>
                  <p className="text-info text-[15px] leading-[22px] font-medium flex-none">
                    40%
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-darklight dark:border-darkborder border border-black/10 p-5 gap-6 rounded">
            <h2 className="text-base font-semibold text-black dark:text-white/80 mb-4 capitalize">
              Users by Device
            </h2>
            <div id="chart6"></div>
              ...
              <table className="min-w-[640px] w-full">
                ...
                <tbody>
                  <tr className="text-muted">
                    ...
                    <td>
                      27%{" "}
                      <span className="bg-success/10 text-success font-bold text-xs px-1 rounded">
                        3.8%
                      </span>
                    </td>
                  </tr>
                  ...
                  <tr className="text-muted">
                    ...
                    <td>
                      37%{" "}
                      <span className="bg-danger/10 text-danger font-bold text-xs px-1 rounded">
                        19.8%
                      </span>
                    </td>
                  </tr>
