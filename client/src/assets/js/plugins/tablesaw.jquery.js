...
(function(root, factory) {
    ...
    (function() {
        ...
        Table.prototype._findPrimaryHeadersForCell = function(cell) {
            ...
            var results = [];
            for (
                var rowNumber = 0; rowNumber < this.headerMapping.length; rowNumber++
            ) {
                if (rowNumber === headerRowIndex) {
                    continue;
                }
                for (
                    var colNumber = 0; colNumber < this.headerMapping[rowNumber].length; colNumber++
                ) {
        ...
        Table.prototype._initCells = function() {
            ...
            for (var colNumber = 0; colNumber < columnLookup[0].length; colNumber++) {
                for (
                    var headerIndex = 0, k = headerRowIndeces.length; headerIndex < k; headerIndex++
                ) {
                    var headerCol =
        ...
        Stack.prototype.init = function() {
            ...
            this.$table
                ...
                .each(function() {
                    ...
                    var $cell = $(this);
                    $(self.tablesaw._findPrimaryHeadersForCell(this)).each(function(
                        index
                    ) {
        ...
        function createSwipeTable(tbl, $table) {
            ...
            function getNext() {
                ...
                $headerCellsNoPersist.each(function(i) {
                    var $t = $(this);
                    var isHidden =
                        $t.css("display") === "none" || $t.is("." + classes.hiddenCol);
            ...
            function matchesMedia() {
                ...
                return (
                    !matchMedia ||
                    ("matchMedia" in window && window.matchMedia(matchMedia).matches)
                );
            }
                ...
                $table.on("touchstart.swipetoggle", function(e) {
                    ...
                    $(this)
                        ...
                        .on("touchend.swipetoggle", function() {
                            ...
                            var isPageScrolled =
                                Math.abs(window.pageYOffset - scrollTop) >= verticalThreshold;
