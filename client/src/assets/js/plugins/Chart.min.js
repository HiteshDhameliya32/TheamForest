...
!(function(t) {
    ...
    return (function t(e, i, n) {
        ...
        for (
            var o = "function" == typeof require && require, r = 0; r < n.length; r++
        )
            a(n[r]);
        return a;
    })({
            ...
            function(t, e, i) {
                ...
                function a(t) {
                    ...
                    return (
                        ...
                        (e = 2 + (o - n) / l) :
                        o == s && (e = 4 + (n - a) / l),
                        (e = Math.min(60 * e, 360)) < 0 && (e += 360), [e, i, ((s / 255) * 1e3) / 10]
                    );
                }
                ...
                function y(t) {
                    var e,
                        ...
                        a = t[2];
                    return (
                        (e = (360 * Math.atan2(a, n)) / 2 / Math.PI) < 0 && (e += 360), [i, Math.sqrt(n * n + a * a), e]
                    );
                }
                        ...
                        (t.controllers.bar = t.DatasetController.extend({
                            ...
                            update: function(t) {
                                var e,
                                    ...
                                    n = this.getMeta().data;
                                for (
                                    this._ruler = this.getRuler(), e = 0, i = n.length; e < i;
                                    ++e
                                )
                                ...
                                var n,
                                    ...
                                    ((n = e),
                                        ...
                                        ((s = a.min * r.categoryPercentage),
                                            (l = r.barPercentage)) :
                                        ((s = u * d), (l = 1)), { chunk: s / d, ratio: l, start: c - s / 2 }),
                        ...
                        t.controllers.doughnut = t.controllers.pie =
                            t.DatasetController.extend({
                                ...
                                getMaxBorderWidth: function(t) {
                                    for (
                                        var e, i, n = 0, a = this.index, o = t.length, r = 0; r < o; r++
                                    )
                        ...
                        (t.animationService = {
                            ...
                            addAnimation: function(t, e, i, n) {
                                var a,
                                    ...
                                    r = this.animations;
                                for (
                                    e.chart = t, n || (t.animating = !0), a = 0, o = r.length; a < o;
                                    ++a
                                )
                    ...
                    a.extend(t.prototype, {
                            ...
                            resize: function(t) {
                                ...
                                if (
                                    ...
                                    ((n.width = e.width = r),
                                        ...
                                        (n.style.width = r + "px"),
                                        (n.style.height = s + "px"),
                                        a.retinaScale(e, i.devicePixelRatio), !t)
                                ) {
                            ...
                            update: function(e) {
                                ...
                                if (
                                    ((e && "object" == typeof e) ||
                                        ...
                                        l._invalidate(o), !1 !== l.notify(o, "beforeUpdate"))
                                ) {
                            ...
                            draw: function(t) {
                                ...
                                e.clear(),
                                    ...
                                    e.transition(t), !1 !== l.notify(e, "beforeDraw", [t]) &&
                                    (a.each(
                                            e.boxes,
                                            function(t) {
                                                t.draw(e.chartArea);
                            ...
                            transition: function(t) {
                                for (
                                    var e = 0, i = (this.data.datasets || []).length; e < i;
                                    ++e
                                )
                            ...
                            drawDatasets: function(t) {
                                ...
                                if (!1 !== l.notify(e, "beforeDatasetsDraw", [t])) {
                                    for (
                                        var i = (e.data.datasets || []).length - 1; i >= 0;
                                        --i
                                    )
                            ...
                            getVisibleDatasetCount: function() {
                                for (
                                    var t = 0, e = 0, i = this.data.datasets.length; e < i;
                                    ++e
                                )
                            ...
                            handleEvent: function(t) {
                                ...
                                return (
                                    ...
                                    a.callback(
                                        n.onHover || n.hover.onHover, [t.native, i.active],
                                        i
                                    ),
            ...
            function(t, e, i) {
                ...
                e.exports = function(t) {
                    ...
                    (o.configMerge = function() {
                        return o.merge(
                            o.clone(arguments[0]), [].slice.call(arguments, 1), {
                                ...
                                merger: function(e, i, n, a) {
                                    if ("xAxes" === e || "yAxes" === e) {
                                        ...
                                        for (i[e] || (i[e] = []), r = 0; r < u; ++r)
                                            ...
                                            r >= i[e].length && i[e].push({}), !i[e][r].type || (l.type && l.type !== i[e][r].type) ?
                                            o.merge(i[e][r], [
                ...
                function o(t, e) {
                    ...
                    for (n = 0, o = t.data.datasets.length; n < o; ++n)
                        if (t.isDatasetVisible(n))
                            for (
                                a = 0, r = (i = t.getDatasetMeta(n)).data.length; a < r;
                                ++a
                            ) {
                                var s = i.data[a];
                                s._view.skip || e(s);
                    ...
                    (e.exports = function(t) {
                        ...
                        t.Scale = a.extend({
                            ...
                            mergeTicksOptions: function() {
                                ...
                                for (var e in (!1 === t.minor && (t.minor = { display: !1 }), !1 === t.major && (t.major = { display: !1 }),
                                        t))
                                    "major" !== e &&
                                    "minor" !== e &&
                            ...
                            update: function(t, e, i) {
                                ...
                                for (
                                    ...
                                    d.maxWidth = t,
                                    d.maxHeight = e,
                                    d.margins = o.extend({ left: 0, right: 0, top: 0, bottom: 0 },
                                        i
                                    ),
                                ...
                                if (a.length && t.options.display && t.isHorizontal())
                                    for (
                                        var u,
                                            ...
                                            c = d,
                                            h = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; c > h && l < n.maxRotation;
                                        ...
                                        (A = (function(t, e) {
                                            ...
                                            (F = (function(t, e) {
                                                ...
                                                return (
                                                    ...
                                                    o.each(e.footer, g), { width: (a += 2 * e.xPadding), height: n }
                                                );
                                            })(this, D))
                                        )),
                                        (a = D),
                ...
                var n,
                    a = {
                        ...
                        clone: function(t) {
                            ...
                            if (a.isObject(t)) {
                                for (
                                    var e = {}, i = Object.keys(t), n = i.length, o = 0; o < n;
                                    ++o
                                )
                                    e[i[o]] = a.clone(t[i[o]]);
                                return e;
                            ...
                            buildTicks: function() {
                                var t = this,
                                    ...
                                    o = (t.ticks = (function(t, e) {
                                        ...
                                        for (
                                            var d = i < 0 ? Math.pow(10, Math.abs(i)) : 1; o.push(s),
                                            10 == ++a && ((a = 1), (d = ++i >= 0 ? 1 : d)),
                                        ...
                                        if (s > 0 || o.reverse) {
                                            ...
                                            if (
                                                ...
                                                if (
                                                    ...
                                                    d.fillRect(-g / 2 - o.backdropPaddingX, -u - h / 2 - o.backdropPaddingY,
                ...
                function m(t, e, i, a) {
                    ...
                    for (
                        ...
                        (f = (function(t, e, i, n) {
                            ...
                            for (
                                a = 0, o = c.length; a < o && ((r = c[a]), !(Math.ceil(s / (d * r)) <= n));
                                ++a
                            );
                            return r;
                        })(t, e, c, i)),
                        ...
                        !g &&
                        !d.round &&
                        (r.startOf(h), r.add(~~((b - r) / (v.size * f)) * f, c)); r < x; r.add(f, c)
                    )
                        y.push(+r);
                    return y.push(+r), y;
                }
