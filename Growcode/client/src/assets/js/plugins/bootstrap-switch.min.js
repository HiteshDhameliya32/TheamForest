...
(function(a, b) {
            ...
            function j(k) {
                ...
                c(this, j),
                    ...
                    (this.$on = g("<span>", {
                        ...
                        class: this._getClass("handle-on") +
                            " " +
                            this._getClass(this.options.onColor),
                    })),
                    (this.$off = g("<span>", {
                        html: this.options.offText,
                        class: this._getClass("handle-off") +
                            " " +
                        ...
                        !1 === l.options.onSwitchChange.apply(k, o) &&
                            (l.$element.is(":radio") ?
                                g('[name="' + l.$element.attr("name") + '"]').trigger(
                                    "previousState.bootstrapSwitch", !0
                                ) :
            ...
            return (
                f(j, [{
                    ...
                    },
                    {
                        ...
                        value: function(l) {
                            return g.isArray(l) ?
                                l.map(this._getClass.bind(this)) : [this._getClass(l)];
                        },
                    },
                ]),
                j
    ...
    (g.fn.bootstrapSwitch = function(j) {
        for (
            var l = arguments.length, m = Array(1 < l ? l - 1 : 0), n = 1; n < l; n++
        )
            m[n - 1] = arguments[n];
