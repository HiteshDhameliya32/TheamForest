    ...
    e.extend(e.validator, {
        ...
        prototype: {
            ...
            formatAndAdd: function (e, t) {
                ...
                this.errorList.push({
                    message: "<span class='errorDV'>" + n + "</span>",
                    element: e
                });
...
jQuery.validator.addMethod("alphabates", function (value, element, param) {
    return this.optional(element) || /^[a-zA-Z ]*$/.test(value);
}, "Name must contain only alphabates.");
...
//    alert(value);
    return this.optional(element) || /^[a-zA-Z0-9\-_]+$/i.test(value) || /[0-9]/i.test(value);
//    return this.optional(element) || /^[a-zA-Z0-9_ ]*$/.test(value);
//    return /^[a-zA-Z0-9_]*$/.test(value);
}, "Plese enter only alphanumeric characters.");
