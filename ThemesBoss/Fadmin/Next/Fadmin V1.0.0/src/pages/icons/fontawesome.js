...
import data from "@/data/fontawesome-icons-list.json"
    ...
    <div className="container-fluid" id="main-wrapper">
      <div className="row">
        <div className="col-lg-12">
          <Card1 >
            <CardHeader1 title="Font Awesome Icons - 6">
            ...
            {data?.fa6.map((icon, index) => {
                return (
                    <div key={index} className="col-sm-6 col-md-4 col-lg-3">
                      <i><DynamicIcon icon={icon}  iconFamily={"fa6"}/></i> {icon}
                    </div>
                  )
              }
              )}
          ...
          <Card1 className="mb-0">
            ...
            <div className="row icon-demo-content">
            {data?.fa.map((icon, index) => {
                return (
                    <div key={index} className="col-sm-6 col-md-4 col-lg-3">
                      <i><DynamicIcon icon={icon}  iconFamily={"fa"}/></i> {icon}
                    </div>
                  )
              }
              )}
