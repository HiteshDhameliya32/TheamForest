          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <div className="navbar-header d-lg-none">
              <div className="logo-sm">
                <a onClick={onOpenSidebar} id="sidebar-toggle-button">
                  <DynamicIcon iconFamily="fa" icon="FaBars"/>
                </a>
              </div>
            </div>
              ...
              <ul className="nav navbar-nav d-none d-lg-flex mb-2 mb-lg-0">
                <li>
                  <a onClick={toggleCollapsMenu} id="collapsed-sidebar-toggle-button">
                    <i>
                      <DynamicIcon icon={"MdMenu"} iconFamily={"md"}/>
                    </i>
                  </a>
                </li>
                <li>
                  <a onClick={toggleFullScreen} id="toggle-fullscreen">
                    <i>
                      <DynamicIcon icon={"MdFullscreen"} iconFamily={"md"} />
                    </i>
                  </a>
                </li>
                <li>
                  <a onClick={toggleSearchbar} id="search-button">
                    <i>
                      <DynamicIcon icon={"MdSearch"}  iconFamily={"md"}/>
                    </i>
                  </a>
                </li>
              </ul>
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="dropdown topbar-head-dropdown header-item">
                ...
                >
                  <i className="fs-20">
                    {
                        theme_mode ==="light" ? 
                        <DynamicIcon icon={"BsMoonStars"} iconFamily={"bs"} size={18} />
                         : <DynamicIcon icon={"BsSun"} iconFamily={"bs"} size={18} />
                    }
                  </i>
                </a>
              </div>
              <div className="ms-1 header-item">
                ...
                >
                  <i className="fs-20">
                    <DynamicIcon icon={"MdOutlineEmail"} iconFamily={"md"} size={18} />
                  </i>
                </a>
              </div>
