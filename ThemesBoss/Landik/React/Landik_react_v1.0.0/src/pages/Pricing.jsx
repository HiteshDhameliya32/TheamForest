          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="pages_banner_content">
                ...
                <p>
                  We offer great prices, premium products and quality service
                  for your business.
                </p>
                <div>
                  <a href="contact.html" class="btn btn-custom btn-sm">
                    Contact US
                  </a>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="text-center section_title">
                ...
                <p class="text-muted mx-auto mb-0 mt-4">
          ...
          <div class="row mt-5">
            <div class="col-lg-4">
              <div class="price_box_fir mx-auto mt-3">
                ...
                <div class="plan_price text-center">
                  <h1 class="mb-0">
                    $29
                    <sub class="text-custom font-weight-normal">/Per Month</sub>
                  </h1>
                </div>
                ...
                <div class="text-center mt-5">
                  <a
                    ...
                    class="btn btn-custom-light btn-hover btn-rounded"
                  >
                    Join Now
                  </a>
                </div>
            ...
            <div class="col-lg-4">
              <div class="price_box_fir active bg-custom rounded mx-auto mt-3">
                ...
                <div class="plan_price text-center">
                  <h1 class="mb-0">
                    $39<sub class="font-weight-normal">/Per Month</sub>
                  </h1>
                </div>
                <div class="price_divider"></div>
                <div class="price_features pb-2 text-center">
                ...
                <div class="text-center mt-5">
                  <a
                    href="javascript:void(0)"
                    class="btn btn-white btn-hover btn-rounded"
                  >
                    Join Now
                  </a>
                </div>
      ...
      <section class="section">
        <div class="container">
          ...
          <div class="row mt-5 align-items-center">
            <div class="col-lg-6">
              <div
                class="nav nav-pills price_nav_custom mt-3 d-block"
                id="pills-tab"
                role="tablist"
              >
                  ...
                  >
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="float-end price_plan responsive_none_float">
                        <h2 class="mb-0">
                          $29<sub class="font-weight-normal">/Per Month</sub>
                        </h2>
                      </div>
                    </div>
                  </a>
                ...
                <div class="nav-item" role="presentation">
                  ...
                  >
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="float-end price_plan responsive_none_float">
                        <h2 class="mb-0">
                          $59<sub class="font-weight-normal">/Per Month</sub>
                        </h2>
                      </div>
                    </div>
                  </a>
                ...
                <div class="nav-item" role="presentation">
                  ...
                  >
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="float-end price_plan responsive_none_float">
                        <h2 class="mb-0">
                          $89<sub class="font-weight-normal">/Per Month</sub>
                        </h2>
                      </div>
                    </div>
                  </a>
            ...
            <div class="col-lg-6">
              <div
                class="tab-content price_tab_detail mx-auto mt-3"
              ...
              >
                ...
                >
                  ...
                  <div class="price_features position-relative">
                    <p class="mt-0">
                      <i class="mdi mdi-check-circle text-custom me-1"></i> 2GB
                      Cloud Storage
                    </p>
                    <p>
                      <i class="mdi mdi-check-circle text-custom me-1"></i>{" "}
                      100GB CDN Bandwidth
                    </p>
                    <p>
                      <i class="mdi mdi-check-circle text-custom me-1"></i>{" "}
                ...
                >
                  ...
                  <div class="price_features position-relative">
                    <p class="mt-0">
                      <i class="mdi mdi-check-circle text-custom me-1"></i> 20GB
                      Cloud Storage
                    </p>
                    <p>
                      <i class="mdi mdi-check-circle text-custom me-1"></i> 1TB
                      CDN Bandwidth
                    </p>
                    <p>
                      <i class="mdi mdi-check-circle text-custom me-1"></i>{" "}
